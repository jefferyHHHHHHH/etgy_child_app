...
class ChildrenApi {
  ...
  Future<Response<ApiAuthRegisterPost201Response>> apiChildrenIdPasswordGet({ 
    required String id,
    ...
    final _path = r'/api/children/{id}/password'.replaceAll('{' r'id' '}', id.toString());
...
_responseData = rawData == null ? null : deserialize<ApiAuthRegisterPost201Response, ApiAuthRegisterPost201Response>(rawData, 'ApiAuthRegisterPost201Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ApiAuthRegisterPost201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiAuthRegisterPost201Response>> apiChildrenIdPasswordPost({ 
    required String id,
